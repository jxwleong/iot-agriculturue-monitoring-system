 ...
 * Title : Send sensor reading to a centralised node
 ...
 */
char *createJsonStringForSensorReadings(int soilMoisture){
 ...
 * @param: Soil Moisture
 */
void sendSensorReadingsToServerNode(int soilMoisture){

  char *message = createJsonStringForSensorReadings(soilMoisture);
  Serial.println("\nPublishing message:");
...
void ISR_FUNC(){
  ...
  sensorData = getSensorData();
  sendSensorReadingsToServerNode(sensorData.soilMoistureData);
  }
}
